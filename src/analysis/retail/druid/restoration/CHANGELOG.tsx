...
import { Oratio, Sref, Vollmer, Phased } from 'CONTRIBUTORS';
import { SpellLink } from 'interface';
import SPELLS from 'common/SPELLS';
import { TALENTS_DRUID } from 'common/TALENTS';

export default [
  change(date(2026, 2, 4), <>Activating Resto Druid analyzer for Midnight. Very early state, cleaned up removed talents to get analyzer in a working state</>, Phased),
  ...
  change(date(2025, 7, 3), <>Updates <SpellLink spell={SPELLS.INNERVATE}/> guide section to evaluate based on ramp active time instead of flat mana saved. Added active time evaluation to guide.</>, Sref),
